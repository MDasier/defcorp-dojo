export default class EEScene extends Phaser.Scene {
	...
	create() {
		...
		const progressBar = this.add.rectangle(barX - barWidth / 2, barY, 0, barHeight, 0x00ccff).setOrigin(0, 0.5);
		...
		this.tweens.add({
			...
			onComplete: () => {
				...
				this.time.delayedCall(800, () => {
					...
					this.scene.resume('GameScene'); // o el nombre de tu escena principal
				});
			}
		});
	}
